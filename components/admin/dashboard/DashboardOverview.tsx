...
const MOCK_DATA = {
  ...
  recent_emergency_alerts: [] as DashboardAlert[],
  upcoming_bookings: [] as DashboardUpcomingBooking[],
    ...
    <div>
        ...
        <div className="card">
          ...
          {!data.recent_emergency_alerts?.length ? (
            ...
            <div className="flex flex-col">
              {data.recent_emergency_alerts.slice(0, 4).map((alert: DashboardAlert) => (
                <div
                  key={alert.id}
      ...
      {(data.upcoming_bookings?.length ?? 0) > 0 && (
        <div className="card" style={{ marginTop: 'var(--space-4)' }}>
          ...
          <div className="flex flex-col">
            {data.upcoming_bookings.map((b: DashboardUpcomingBooking) => (
              <div
                key={b.id}
                className="flex items-center gap-3"
                style={{
