...
/**
 * Built once at module load rather than during render: `new Date()` and
 * `Math.random()` are impure, and re-deriving them each render made the chart
 * jitter (and tripped react-hooks/purity).
 */
const FALLBACK_ANALYTICS: TelegramAnalytics = {
...
export function TelegramAnalyticsDashboard() {
  ...
  // Fallback mock data
  const analytics: TelegramAnalytics = data || FALLBACK_ANALYTICS
